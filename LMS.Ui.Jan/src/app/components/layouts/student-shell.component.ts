...
@Component({
    ...
    <div class="shell">
      <aside class="sidebar student">
        ...
        <nav>
          ...
          <a routerLink="/student/my-courses" routerLinkActive="active">MyCourses</a>
          <a routerLink="/student/assignments" routerLinkActive="active">Assignments</a>
        </nav>
  ...
  styles: [`
    ...
    .sidebar.student { background: linear-gradient(180deg, #ff8c37 0%, #ff512f 100%); }
