  ...
  template: `
    <div class="page">
      <div class="welcome-section">
        ...
        <p class="welcome-subtitle">Manage student assignment submissions</p>
      </div>
      ...
      <div class="search-container">
        <mat-form-field class="search-field" appearance="outline">
          <input 
            ...
            [(ngModel)]="searchText" 
            (input)="applyFilter()" 
            placeholder="Search by name, course name, assignment title or solution">
...
export class AdminSubmissionsComponent implements OnInit {
  ...
  setupCustomFilter(): void {
    this.dataSource.filterPredicate = (data: any, filter: string) => {
      ...
      return data.studentFirstName.toLowerCase().includes(searchStr) ||
